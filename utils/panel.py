...
def Panel():
    ...
    table = Table(title="Client Sunucu Kopyalama", show_header=True, header_style="bold")
    ...
    paragraph = """clientsex Tarafından Hazırlanmıştır. Yan Hesap Açıp Kullanmanız Tavsiye Edilmiştir. Discord: discord.gg/Swsy7hvDSs"""
...
def Panel_Run(guild, user):
    ...
    footer.add_row(f"[bold magenta]Sunucu ID: [green]{guild}")
